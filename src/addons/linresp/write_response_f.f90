...
write(160,'("#")')
allocate(func(22,lr_nw))
do ie=1,lr_nw
  if (timgw) then
    func(1,ie)=dimag(lr_w(ie))*ha2ev
  else
  ...
  func(21,ie)=-dreal(f_response(f_jdos,ie,ifxc))/ha2ev/(au2ang)**3
  func(22,ie)=-dimag(f_response(f_jdos,ie,ifxc))/ha2ev/(au2ang)**3
  write(160,'(22G32.24)')func(1:22,ie)
enddo
deallocate(func)
close(160)
